...
class DBStorePipeline(object):
    ...
    def __init__(self, dynamodb_region_name, dynamodb_uri,
    ...
    def from_crawler(cls, crawler):
        ...
        return cls(dynamodb_region_name=args['dynamodb_region_name'],
            dynamodb_uri=args['dynamodb_uri'],
            neo4j_uri=args['neo4j_uri'],
            neo4j_user=args['neo4j_user'], neo4j_password=args['neo4j_password'],
            sql_config=args['sql_config'])
